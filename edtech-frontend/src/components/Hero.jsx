...
<div className="absolute bottom-[-60px] right-[-60px] w-[360px] h-[360px] rounded-full bg-purple-600 opacity-20 blur-[100px] animate-pulse" style={{ animationDelay: "1s" }} />
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-cyan-500 opacity-10 blur-[80px] animate-pulse" style={{ animationDelay: "2s" }} />
</div>
...
<p className="text-white text-xs md:text-sm font-medium tracking-wide">
     🎓 Join <span className="font-bold">2,500+ students</span> who transformed their careers with InnovationAILabs
...
<p className="text-gray-300 text-base md:text-lg mb-8 leading-relaxed max-w-lg">
         Industry-ready certificate programs with <span className="text-cyan-400 font-semibold">live internships</span>,
         real-world projects, and <span className="text-purple-400 font-semibold">guaranteed placement support</span>.
         Learn from experts. Build. Deploy. Get hired.
</p>
       {/* CTA Buttons */}
<div className="flex flex-col sm:flex-row gap-4 mb-10">
<Link
           to="/courses"
           className="px-8 py-4 rounded-xl text-base font-bold bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 transition shadow-lg shadow-blue-500/30 text-center"
>
           🚀 Explore Courses
</Link>
<Link
           to="/register"
           className="px-8 py-4 rounded-xl text-base font-bold border-2 border-blue-500/50 text-white hover:bg-blue-500/10 transition text-center"
>
           Get Free Counselling →
</Link>
</div>
       {/* Trust logos / partner text */}
<div className="flex items-center gap-3 flex-wrap">
<span className="text-gray-500 text-xs uppercase tracking-widest">Trusted by graduates at</span>
         {["Infosys", "TCS", "Accenture", "Wipro", "Capgemini"].map(c => (
<span key={c} className="text-gray-400 text-xs font-semibold border border-gray-700 rounded px-2 py-0.5">
             {c}
</span>
         ))}
</div>
...
<div
           key={i}
           className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-5 hover:bg-white/10 transition hover:-translate-y-1 duration-300"
...
<div
         key={i}
         className="flex-shrink-0 w-56 md:w-72 h-36 md:h-44 rounded-2xl overflow-hidden border border-white/10 hover:scale-105 transition duration-300"
>
<img src={img} alt="course visual" className="w-full h-full object-cover" />
</div>
     ))}
</div>
</div>
